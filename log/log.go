...
func NewLogger() *GodspeedLogger {
	return &GodspeedLogger{Level: INFO}
}

var std = NewLogger()

func (m *GodspeedLogger) Trace(format string, v ...interface{}) {
	m.Log(TRACE, format, v...)
}

func (m *GodspeedLogger) Debug(format string, v ...interface{}) {
	m.Log(DEBUG, format, v...)
}

func (m *GodspeedLogger) Info(format string, v ...interface{}) {
	m.Log(INFO, format, v...)
}

func (m *GodspeedLogger) Warn(format string, v ...interface{}) {
	m.Log(WARN, format, v...)
}

func (m *GodspeedLogger) Error(format string, v ...interface{}) {
	m.Log(ERROR, format, v...)
}

func (m *GodspeedLogger) Fatal(v ...interface{}) {
	s := fmt.Sprint(v...)
	m.Log(FATAL, s)
	os.Exit(1)
}

func (m *GodspeedLogger) Fatalf(format string, v ...interface{}) {
	s := fmt.Sprintf(format, v...)
	m.Log(FATAL, s)
	os.Exit(1)
}

func (m *GodspeedLogger) Log(l LogLevel, format string, v ...interface{}) {
	if l >= m.Level {
		var level string
		var colorFormat = ""
		switch l {
...
func (m *GodspeedLogger) SetLevel(l LogLevel) {
	m.Level = l
}
